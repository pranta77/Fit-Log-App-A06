...
const WorkDetailPage = async ({ params }) => {
  ...
  return (
    ...
    <main className="min-h-screen bg-[#0B0D0F] p-8 container mx-auto">
      <div className="grid gap-10 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-8 rounded-2xl border border-[#292D35] bg-[#15171C]">
            ...
            <div className="flex justify-between border-b border-[#292D35] px-5 py-4">
              ...
              <span className="text-right text-white">{workout.equipment}</span>
            </div>
          ...
          <div className="mt-10">
            <h2 className="text-2xl font-extrabold text-white">INSTRUCTIONS</h2>
